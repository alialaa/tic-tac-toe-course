...
exports.handler = async event => {
    ...
    //3. Check that the current user is a perticipant in the game and that it's his turn
    ...
    //5. Update the state, check id the move is a terminal one & update the winner, status, turn, state
